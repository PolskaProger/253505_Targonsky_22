...
from .models import News, FAQ, Review, Banner, Promotional_code, Job,Partner
...
def home(request):
    ...
    return render(request, 'main/home.html', context={'services': services, 'news': news, 'banners': banners, 'partners': partners})
